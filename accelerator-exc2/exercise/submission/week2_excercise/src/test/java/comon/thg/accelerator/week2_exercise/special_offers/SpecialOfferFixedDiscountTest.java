...
class SpecialOfferFixedDiscountTest {
    ...
    @BeforeEach
    public void setup() {
        CYBER30 = new SpecialOfferFixedDiscount("CYBER30", 30, 75);
        offerList.add(CYBER30);

        BLACKFRIDAY50 = new SpecialOfferFixedDiscount("BLACKFRIDAY50", 50, 150);
    ...
    public void testDiscount() {
        ...
        assertEquals(50, basket80.getTotalAfterDiscountGBP());

        //BLACKFRIDAY50 = MINIMUM SPEND £75 - £50 DISCOUNT
        assertEquals(110, basket160.getTotalAfterDiscountGBP());
    }
